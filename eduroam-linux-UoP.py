...
Config.instname = "University of Pécs"
Config.profilename = ""
Config.url = " \
    ""https://kancellaria.pte.hu/szervezet/informatikai_es_innovacios_igazgatosag/vezetek_nelkuli_wifi_halozat"
Config.email = "sd@pte.hu"
Config.title = "eduroam CAT"
Config.server_match = "pte.hu"
...
Config.user_realm = "tr.pte.hu"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:iig-radius1.pte.hu', 'DNS:iig-radius2.pte.hu', 'DNS:rds1.tr.pte.hu', 'DNS:rds2.tr.pte.hu']
